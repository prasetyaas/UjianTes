...
<div class="sidebar">
	<h3><i class="fa fa fa-shopping-cart"></i> RM Murah Meriah</h3>
	<ul><?php
			if ($_SESSION['status']==1) {
				?>
					...
					<li><a id="users" href="users.php"><i class="fa fa-users"></i> Staff</a></li>
				...
				?>
					<li><a id="transaksi" href="transaksi.php"><i class="fa fa-money"></i> Transaksi</a></li><?php
			}
		?>
		</ul>
</div>
