...
<html>
<head>
	<title>Login | Aplikasi Pemesanan</title>
	<style type="text/css">
	@font-face{
	...
	100%{opacity: 1;}
		...
		.both{clear: both;}
		.loginpage{position: fixed;background:url("assets/img/wp99.jpg");height: 100%;width: 100%;background-size: 100%;}
...
<body>
	<div class="loginpage">
		...
		<div class="padding">
			<h3>Login Aplikasi Pemesanan</h3>
		<form id="loginapp">
			...
			<select name="loginas" required="required">
				...
				<option value="2">Kasir/Pelayan</option>
			</select>
