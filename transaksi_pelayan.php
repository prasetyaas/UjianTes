...
<?php
	if (isset($_GET['action']) && $_GET['action']=="transaksi_baru_pelayan") {
		include "transaksi_baru_pelayan.php";
	}
	else if (isset($_GET['action']) && $_GET['action']=="detail_transaksi") {
		include "detail_transaksi_pelayan.php";
	}

	else{
?>
<script type="text/javascript">
	document.title="Transaksi Pelayan";
	document.getElementById('transaksi_pelayan').classList.add('active');
</script>
<div class="content">
	<div class="padding">
		<div class="bgwhite">
			...
			<div class="contenttop">
				<div class="left">
					<a href="?action=transaksi_baru_pelayan" class="btnblue">Transaksi Baru</a>
				</div>
				<div class="both"></div>
			</div>
