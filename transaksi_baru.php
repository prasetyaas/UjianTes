...
if('submit'){
write_log("Sukses Transaksi");
}else{
write_log("Gagal Transaksi");
}
	...
	<div class="padding">
		<div class="bgwhite">
			<div class="padding">
				...
				<form class="form-input" method="post" action="handler.php?action=tambah_tempo" style="padding-top: 30px;">
					...
					<input type="hidden" name="trx" value="<?php echo date("d")."/AF/".$_SESSION['status']."/".date("y") ?>">
		...
		<div class="bgwhite">
			...
			<form class="form-input" action="handler.php?action=selesai_transaksi" method="post">
					...
					<input required="required" type="text" name="nomor_meja">
